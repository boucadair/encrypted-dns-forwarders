...
trust a certificate and (probably worst of all) clicking through certificate
warnings will become normalized.

Modifying self-signed certificate handling for ".local" {{?RFC6761}}
or ".internal" {{?I-D.davies-internal-tld}} for unique names is worthy
of consideration.
